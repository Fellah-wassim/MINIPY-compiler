...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_key_word_BOOL = 5,              /* key_word_BOOL  */
  YYSYMBOL_key_word_ASSIGNMENT = 6,        /* key_word_ASSIGNMENT  */
  YYSYMBOL_CST_BOOL = 7,                   /* CST_BOOL  */
  YYSYMBOL_CST_FLOAT = 8,                  /* CST_FLOAT  */
  YYSYMBOL_CST_CHAR = 9,                   /* CST_CHAR  */
  YYSYMBOL_key_word_CHAR = 10,             /* key_word_CHAR  */
  YYSYMBOL_key_word_INTEGER = 11,          /* key_word_INTEGER  */
  YYSYMBOL_key_word_FLOAT = 12,            /* key_word_FLOAT  */
  YYSYMBOL_key_word_EQUAL = 13,            /* key_word_EQUAL  */
  YYSYMBOL_key_word_NOT_EQUAL = 14,        /* key_word_NOT_EQUAL  */
  YYSYMBOL_openSquareBracket = 15,         /* openSquareBracket  */
  YYSYMBOL_closeSquareBracket = 16,        /* closeSquareBracket  */
